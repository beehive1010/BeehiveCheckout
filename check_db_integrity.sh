...
echo ""
echo "1. 检查Root用户信息:"
curl -s -X POST "https://cvqibjcbfrwsgkvthccp.supabase.co/functions/v1/activate-membership" \
...
curl -s -X POST "https://cvqibjcbfrwsgkvthccp.supabase.co/functions/v1/matrix" \
-H "Content-Type: application/json" \
-H "x-wallet-address: 0x0000000000000000000000000000000000000001" \
-d '{
...
curl -s -X GET "https://cvqibjcbfrwsgkvthccp.supabase.co/functions/v1/rewards/user" \
-H "Content-Type: application/json" \
