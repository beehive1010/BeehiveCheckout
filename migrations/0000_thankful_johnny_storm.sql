...
CREATE TABLE "matrix_layers" (
	...
	CONSTRAINT "matrix_layers_wallet_address_layer_pk" PRIMARY KEY("wallet_address","layer")
);
--> statement-breakpoint
CREATE TABLE "member_activation_status" (
	"wallet_address" varchar(42) PRIMARY KEY NOT NULL,
	"is_activated" boolean DEFAULT false NOT NULL,
	"activation_level" integer DEFAULT 0 NOT NULL,
	"activated_at" timestamp,
	"pending_until" timestamp,
	"upgrade_timer_active" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "member_activations" (
	...
	"activated_at" timestamp,
	"pending_timeout_hours" integer DEFAULT 24 NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "member_levels" (
	...
	"max_level_achieved" integer DEFAULT 0 NOT NULL,
	"levels_owned" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"nft_token_ids" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"total_nfts_owned" integer DEFAULT 0 NOT NULL,
	"first_activation_at" timestamp,
	"last_level_upgrade_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "membership_state" (
	"wallet_address" varchar(42) PRIMARY KEY NOT NULL,
	"levels_owned" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"active_level" integer DEFAULT 0 NOT NULL,
	"joined_at" timestamp,
	"last_upgrade_at" timestamp
);
--> statement-breakpoint
...
CREATE TABLE "referral_nodes" (
	...
	"matrix_position" integer DEFAULT 0 NOT NULL,
	"left_leg" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"middle_leg" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"right_leg" jsonb DEFAULT '[]'::jsonb NOT NULL,
...
ALTER TABLE "global_matrix_position" ADD CONSTRAINT "global_matrix_position_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "matrix_layers" ADD CONSTRAINT "matrix_layers_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "member_activation_status" ADD CONSTRAINT "member_activation_status_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "member_activations" ADD CONSTRAINT "member_activations_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "member_levels" ADD CONSTRAINT "member_levels_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "membership_state" ADD CONSTRAINT "membership_state_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "referral_layers" ADD CONSTRAINT "referral_layers_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "referral_nodes" ADD CONSTRAINT "referral_nodes_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "reward_distributions" ADD CONSTRAINT "reward_distributions_recipient_wallet_users_wallet_address_fk" FOREIGN KEY ("recipient_wallet") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "reward_notifications" ADD CONSTRAINT "reward_notifications_recipient_wallet_users_wallet_address_fk" FOREIGN KEY ("recipient_wallet") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "usdt_balances" ADD CONSTRAINT "usdt_balances_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_activities" ADD CONSTRAINT "user_activities_wallet_address_users_wallet_address_fk" FOREIGN KEY ("wallet_address") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_rewards" ADD CONSTRAINT "user_rewards_recipient_wallet_users_wallet_address_fk" FOREIGN KEY ("recipient_wallet") REFERENCES "public"."users"("wallet_address") ON DELETE no action ON UPDATE no action;