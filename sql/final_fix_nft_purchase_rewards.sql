-- 最终修复NFT购买奖励函数的字段名称问题

BEGIN;

SELECT '=== 最终修复NFT购买奖励函数 ===' as step;
    ...
    LOOP
        ...
        IF reward_record.reward_eligible THEN
            ...
            INSERT INTO reward_claims (
                ...
                reward_record.matrix_root, reward_record.reward_amount, 'claimable', now(), now() + interval '30 days',
...
SELECT '=== NFT购买奖励函数修复完成 ===' as final_status;
