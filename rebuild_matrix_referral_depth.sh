...
echo "🔄 Starting Matrix rebuild with referral depth layers + L→M→R priority..."
...
for ROOT in $ROOTS; do
    ...
    # Process this root: layer = referral depth, position = L→M→R priority within each layer
