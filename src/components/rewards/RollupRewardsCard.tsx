  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="relative overflow-hidden bg-gradient-to-br from-purple-500/10 to-violet-500/10 border border-purple-500/20 hover:shadow-lg hover:scale-[1.02] transition-all duration-300">
      ...
      <Card className="border-0 shadow-lg bg-gradient-to-br from-background via-background to-muted/20">
        ...
        {/* Enhanced Rollup Reasons Breakdown */}
        {Object.keys(rollupStats.by_reason).length > 0 && (
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-lg font-bold text-foreground">{t('rewards.rollup.rollupBreakdown')}</h4>
            </div>
                  ...
                  <div className="flex items-center justify-between p-4 relative">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <Badge 
                          variant="outline" 
                          className={`${getRollupReasonColor(reason)} font-medium mb-1`}
                        >
        ...
        {/* Enhanced Recent Rollups Timeline */}
        {rollupStats.recent_rollups.length > 0 && (
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-lg font-bold text-foreground">{t('rewards.rollup.recentRollups')}</h4>
            </div>
            
            <div className="relative">
              {/* Timeline Line */}
              <div className="absolute left-5 top-0 bottom-0 w-0.5 bg-gradient-to-b from-honey via-orange-500 to-transparent" />
              
              <div className="space-y-4 max-h-80 overflow-y-auto custom-scrollbar">
                {rollupStats.recent_rollups.map((reward, index) => (
                  <div 
                    key={reward.id} 
                  ...
                  >
                    {/* Timeline Node */}
                    <div className="relative z-10 w-10 h-10 rounded-full bg-gradient-to-br from-honey to-orange-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <ArrowUpRight className="h-4 w-4 text-white" />
                    </div>
                    
                    {/* Content Card */}
                    <Card className="flex-1 border-border/50 hover:border-honey/30 transition-all duration-300 hover:shadow-md hover:translate-x-1">
                      <CardContent className="p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div className="space-y-1">
                            ...
                            <Badge 
                              variant="outline" 
                              className={`${getRollupReasonColor(reward.roll_up_reason)} text-xs`}
                            >
