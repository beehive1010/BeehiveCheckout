          ...
          <CardHeader className="cursor-pointer hover:bg-muted/50 transition-colors pb-3">
            ...
            <div className="flex flex-col gap-2 sm:hidden">
              ...
              <div className="flex items-center gap-2">
                <div className={`w-3 h-3 rounded-full ${urgency.bg} border-2 ${urgency.border} flex-shrink-0`} />
                <Award className="h-4 w-4 text-honey flex-shrink-0" />
                <span className="font-medium text-sm flex-1 truncate">
                  {t('rewards.pendingRewardTimer')} #{reward.matrix_layer || 1}
                </span>
                <Badge
                  variant="outline"
                  className={`${urgency.bg} ${urgency.color} ${urgency.border} text-xs flex-shrink-0`}
                >
              ...
              {/* Middle Row: Amount and Time */}
              <div className="flex items-center justify-between pl-5">
                <div className="font-bold text-honey text-base">
...
export function PendingRewardsList({ rewards, onRewardExpired, variant = 'compact' }: PendingRewardsListProps) {
  ...
  return (
    <div className="space-y-3" data-testid="pending-rewards-list">
      {/* Summary Header */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1 sm:gap-0 text-sm">
        ...
        <CardContent className="pt-4 pb-4">
          <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center">
            <div>
              ...
              <div className="text-[10px] sm:text-xs text-muted-foreground">{t('common.safe')}</div>
            </div>
            <div>
              ...
              <div className="text-[10px] sm:text-xs text-muted-foreground">{t('common.warning')}</div>
            </div>
            <div>
              ...
              <div className="text-[10px] sm:text-xs text-muted-foreground">{t('common.critical')}</div>
            </div>
          </div>
        </CardContent>
      </Card>
