  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bottom-0 left-0 right-0 rounded-t-[20px] data-[state=open]:slide-in-from-bottom data-[state=closed]:slide-out-to-bottom",
        // Desktop: centered modal
        "sm:left-[50%] sm:top-[50%] sm:bottom-auto sm:right-auto sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-lg sm:rounded-lg",
    ...
    >
      ...
      <div className="mx-auto mb-2 h-1.5 w-[60px] rounded-full bg-honey/40 sm:hidden" />
      {children}
