  ...
  const handleTransactionSuccess = async (result: any) => {
    ...
    try {
      ...
      if (activationSuccess) {
        ...
        toast({
          title: '🎉 Level 1 NFT Claimed!',
          description: 'Welcome to BEEHIVE! Your Level 1 membership is now ActiveMember.',
          variant: "default",
          duration: 6000,
        });
        ...
        try {
          ...
          try {
            ...
            if (webhookResponse.ok) {
              ...
              toast({
                title: '🎉 Level 1 NFT Claimed!',
                description: 'Welcome to BEEHIVE! Your Level 1 membership is now ActiveMember via webhook.',
                variant: "default",
                duration: 6000,
              });
