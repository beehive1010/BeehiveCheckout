...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      get_all_matrix_roots: {
        Args: Record<PropertyKey, never>
        Returns: {
          direct_referrals_count: number
          matrix_members_count: number
          root_level: number
      ...
      get_matrix_downline: {
        Args: { p_max_depth?: number; p_root_wallet: string }
        Returns: {
      ...
      get_matrix_navigation: {
        Args: { p_current_root: string }
        Returns: Json
      }
      get_matrix_stats: {
