...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      user_balances: {
        Row: {
          bcc_earned_rewards: number | null
          bcc_locked: number
          bcc_locked_staking: number | null
          bcc_locked_total: number | null
          bcc_pending_activation: number | null
    ...
    Functions: {
      activate_member_with_nft_claim: {
        Args: {
          p_nft_type?: string
      ...
      process_activation_rewards: {
        Args: {
          p_activation_level?: number
      ...
      process_referral_rewards: {
        Args: { p_activation_level?: number; p_new_member_wallet: string }
        Returns: Json
      }
