...
BEGIN
    ...
    (
        ...
        'The world largest NFT marketplace. Discover unique digital assets, collect rare items, and trade with confidence.',
    ...
    (
        'Binance - World Leading Cryptocurrency Exchange',
        'Trade 500+ cryptocurrencies with the world most trusted exchange. Advanced trading tools, low fees, and 24/7 support.',
